...
def top_5_selection(analysed_tweets, engagement_type:str):   # usage
...
def create_tweet(prompt):
    with open("analyzed_tweets.json") as f:
        ...
        PROMPT: {prompt}
          Guidelines:
        - Use a conversational, catchy tone.
        - Keep it under 280 characters.
        - Optionally include 1-2 trending hashtags.
        ...
        Relevance - Is the content aligned with the given topic on context?
        ...
        # 🔹 Added return so Flask can use the data
        return {
         "tweet_a": tweet_a,
         "tweet_b": tweet_b,
